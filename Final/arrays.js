...
if(colorMode == "dark") {
    ...
    document.getElementById("stats").classList.add("darkMode");
    document.getElementById("tituloboard").classList.add("backgrand");
...
botonLight.addEventListener('click', () => {
    ...
    document.getElementById("stats").classList.remove("darkMode");
    document.getElementById("tituloboard").classList.remove("backgrand");
